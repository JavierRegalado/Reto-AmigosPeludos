...
public class Animal {
	...
	// Contador histórico estático: nunca retrocede, único e irrepetible
	...
	private final int numeroRegistro; // ID único e irrepetible asignado en construcción
	...
	// Constructor vacío
	public Animal() {
		this.numeroRegistro = ++contadorHistorico;
	}
 
	public Animal(String idAnimal, String idCentro, String nombreAnim, int edadMeses, Especie especie,
			String caracteristicas, String necesidadesEspeciales, boolean desdeBD) {
	...
	// --- GETTER DEL CONTADOR (solo lectura, no hay setter) ---
 
	public int getNumeroRegistro() {
		return numeroRegistro;
	}
 
	/** Devuelve el total de animales creados hasta ahora (histórico global). */
	public static int getTotalAnimalesCreados() {
	...
	public String toString() {
		return "Animal [#Registro=" + numeroRegistro + ", ID=" + idAnimal + ", Centro=" + idCentro + ", Nombre="
				+ nombreAnim + ", Edad(meses)=" + edadMeses + ", Especie=" + especie + ", Caracteristicas="
