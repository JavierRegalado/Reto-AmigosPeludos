...
public class Adopcion {
	...
	public Adopcion(String idSolicitud, String idAnimal, String dniAdoptante, LocalDate fechaSolicitud,
			EstadoAdopcion estado, boolean desdeBD) {
	...
	/** Devuelve el total de adopciones creadas hasta ahora (histórico global). */
	public static int getTotalAdopcionesCreadas() {
	...
	public void setDniAdoptante(String dniAdoptante) {
		...
		this.dniAdoptante = dniAdoptante.toUpperCase();
	}
	...
	public String toString() {
		return "Adopcion [#Registro=" + numeroRegistro + ", ID Solicitud=" + idSolicitud + ", ID Animal=" + idAnimal
				+ ", DNI Adoptante=" + dniAdoptante + ", Fecha=" + fechaSolicitud + ", Estado=" + estado + "]";
	}
